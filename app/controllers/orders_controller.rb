class OrdersController < ApplicationController
  ...
  def index
    @orders = Order.order(order_date: :desc, created_at: :desc)
  
    @total_pork = @orders.sum(:pork_qty)
  ...
  private
    ...
    def order_params
      params.expect(order: [ :order_date, :customer_name, :customer_address, :pork_qty, :chicken_qty, :delivery_channel, :delivery_fee, :delivery_date, :status ])
    end
end
